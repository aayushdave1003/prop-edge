"""Train and evaluate a batter RBI prediction model.

Predicts expected RBI count for a batter given features from
...
MODEL_PATH = MODEL_DIR / "rbis_v1.txt"
META_PATH = MODEL_DIR / "rbis_v1_meta.json"

TARGET = "rbis"

FEATURE_KEYS = [
    # Batter own rolling RBI / power
    "last_5_avg_rbis",
    "last_10_avg_rbis",
    "last_20_avg_rbis",
    "season_avg_rbis",
    "last_10_rate_over_0.5_rbis",
    "last_10_rate_over_1.5_rbis",
    # Related power/hit signals
...
def evaluate(model, test_df):
    ...
    baseline = test_df["season_avg_rbis"].values
    ...
    print("\n=== Calibration: model says X% over Y.5 RBI, actual rate ===")
    for line in [0.5, 1.5]:
