"""Train RBI prediction model. Poisson objective. Filter: PA >= 3."""
import json
...
FEATURE_KEYS = [
    ...
    "last_10_rate_over_0.5_rbis","last_10_rate_over_1.5_rbis",
    ...
    "last_5_avg_runs","last_10_avg_runs",
    ...
    "season_avg_batter_hard_contact","last_10_avg_pitcher_command","park_factor",
]
