"""Train and evaluate a batter hits prediction model.

Predicts expected hit count for a batter given features from
...
MODEL_PATH = MODEL_DIR / "hits_v1.txt"
META_PATH = MODEL_DIR / "hits_v1_meta.json"
...
FEATURE_KEYS = [
    ...
    "last_20_avg_hits",
    "season_avg_hits",
    "last_10_rate_over_0.5_hits",
    "last_10_rate_over_1.5_hits",
    "last_10_rate_over_2.5_hits",
    ...
    "last_10_avg_at_bats",
    "season_avg_at_bats",
    "last_5_avg_strikeouts",
    "last_10_avg_strikeouts",
    "season_avg_strikeouts",
    "last_5_avg_walks",
    "last_10_avg_walks",
    "last_5_avg_runs",
    "last_10_avg_runs",
    ...
    "games_played_season",
    # Opposing pitcher
    "pitcher_last_5_k_rate",
    "pitcher_last_10_k_rate",
    "pitcher_last_5_h_per_9",
    "pitcher_last_10_h_per_9",
    "pitcher_last_5_bb_per_9",
...
def load_training_data():
    ...
    for k in FEATURE_KEYS:
        if k in derived.columns:
            ...
            out[k] = 0
    # Filter out rows with no rolling history (player making first appearance)
...
def evaluate(model, test_df):
    ...
    baseline = test_df["season_avg_hits"].values
    ...
    print("\n=== Calibration: model says X% over Y.5 hits, actual rate ===")
