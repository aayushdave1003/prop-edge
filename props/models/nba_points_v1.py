"""Train and evaluate an NBA points prediction model.

Predicts expected points for an NBA player given features from
player_games.derived. LightGBM with Poisson objective.

Time-based train/test split: train before 2026-01-01 (full 2024-25 regular
season + playoffs + early 2025-26), test on Jan 2026 onward.

Filter: minutes_played >= 10. Excludes garbage-time and DNP rows.
"""
import json
...
MODEL_PATH = MODEL_DIR / "nba_points_v1.txt"
META_PATH = MODEL_DIR / "nba_points_v1_meta.json"
...
FEATURE_KEYS = [
    ...
    "last_10_rate_over_24.5_points",
    "last_5_avg_fg_attempted",
    "last_10_avg_fg_attempted",
    "season_avg_fg_attempted",
    "last_5_avg_fg_made",
    "last_10_avg_fg_made",
    ...
    "last_5_avg_ft_made",
    "last_10_avg_ft_made",
    "last_5_avg_ft_attempted",
    "last_10_avg_ft_attempted",
    "last_5_avg_minutes",
    "last_10_avg_minutes",
    "last_20_avg_minutes",
    "season_avg_minutes",
...
def evaluate(model, test_df):
    ...
    print("\n=== Calibration: model says X% over Y.5 points, actual rate ===")
    for line in [9.5, 14.5, 19.5, 24.5, 29.5]:
