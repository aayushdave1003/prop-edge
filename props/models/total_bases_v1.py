"""Train and evaluate a batter total bases prediction model.

Predicts expected total bases (1B=1, 2B=2, 3B=3, HR=4) for a batter
given features from player_games.derived. LightGBM with Poisson objective.

Time-based train/test split: train before 2025-01-01, test 2025+.
"""
import json
...
FEATURE_KEYS = [
    # Batter own rolling - hits/TB/power
    "last_5_avg_total_bases",
    "last_10_avg_total_bases",
    "last_20_avg_total_bases",
    "season_avg_total_bases",
    "last_10_rate_over_1.5_total_bases",
    "last_10_rate_over_2.5_total_bases",
    "last_10_rate_over_3.5_total_bases",
    "last_5_avg_hits",
    "last_10_avg_hits",
    "season_avg_hits",
...
def evaluate(model, test_df):
    ...
    print("\n=== Calibration: model says X% over Y.5 TB, actual rate ===")
