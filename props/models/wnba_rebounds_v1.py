"""Train WNBA rebounds prediction model."""
import json
...
MODEL_PATH = MODEL_DIR / "wnba_rebounds_v1.txt"
META_PATH  = MODEL_DIR / "wnba_rebounds_v1_meta.json"
...
def main():
    ...
    mae_b  = np.mean(np.abs(test_df["season_avg_rebounds"].values - y_test))
