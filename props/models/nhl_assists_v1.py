"""Train NHL assists prediction model (skaters only)."""
import json
...
MODEL_PATH = MODEL_DIR / "nhl_assists_v1.txt"
META_PATH  = MODEL_DIR / "nhl_assists_v1_meta.json"
...
FEATURE_KEYS = [
    ...
    "last_20_avg_assists",
    "season_avg_assists",
    "last_10_rate_over_0.5_assists",
    "last_10_rate_over_1.5_assists",
    "last_10_rate_over_2.5_assists",
    "last_5_avg_shots",
    "last_10_avg_shots",
    "last_5_avg_powerplay_points",
    "last_10_avg_powerplay_points",
    "last_5_avg_minutes",
    "last_10_avg_minutes",
    "season_avg_minutes",
    "last_10_avg_points",
