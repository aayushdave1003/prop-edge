"""Train and evaluate an NBA assists prediction model.

Predicts expected assists for an NBA player given features from
...
MODEL_PATH = MODEL_DIR / "nba_assists_v1.txt"
META_PATH = MODEL_DIR / "nba_assists_v1_meta.json"
...
FEATURE_KEYS = [
    ...
    "last_20_avg_assists",
    "season_avg_assists",
    "last_10_rate_over_2.5_assists",
    "last_10_rate_over_4.5_assists",
    "last_10_rate_over_6.5_assists",
    # Minutes (dominant signal)
    "last_5_avg_minutes",
    "last_10_avg_minutes",
    "last_20_avg_minutes",
    "season_avg_minutes",
    # Usage signals (PGs handle ball)
    "last_5_avg_turnovers",
    ...
    "is_back_to_back",
    "team_days_rest",
    "last_10_avg_assists_home",
    "last_10_avg_assists_away",
    ...
    "games_last_7_days",
    "opp_last10_allowed_assists_to_pos",
...
def evaluate(model, test_df):
    ...
    baseline = test_df["season_avg_assists"].values
    ...
    print("\n=== Calibration: model says X% over Y.5 assists, actual rate ===")
    for line in [2.5, 4.5, 6.5, 8.5]:
